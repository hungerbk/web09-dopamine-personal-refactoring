...
import CategoryCard from '@/app/(with-sidebar)/issues/_components/categories/category-card';
import CommentWindow from '@/app/(with-sidebar)/issues/_components/comments/comment-window';
